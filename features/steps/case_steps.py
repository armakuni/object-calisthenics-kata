...
from src.intrastructure import case_store, mail_service
from src.intrastructure.mail_service import Email
from src.questionnaire.actions import case_actions
...
def create_case_for_respondent(context, respondent_name: str):
    ...
    case_actions.create_cases(context.questionnaire_id, context.respondents)
...
@capture_exception(case_actions.CreateCasesError)
def create_example_cases(context, questionnaire_id):
    ...
    case_actions.create_cases(questionnaire_id, respondents)
...
def assert_case_completed(context):
    case = case_store.fetch_by_uac(context.case_uac)
